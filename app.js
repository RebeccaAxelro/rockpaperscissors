    ...
    const playMatch = () => {
        ...
        options.forEach(option => {
            option.addEventListener('click', function () {
                //console.log(this); // this is whatever we click on - rock, paper, .. the option
                // Computer Choice
                const computerNumber = Math.floor(Math.random() * 3); //generate a number btwn 1 and 0, now mult by 3, round to 0 1 or 2
